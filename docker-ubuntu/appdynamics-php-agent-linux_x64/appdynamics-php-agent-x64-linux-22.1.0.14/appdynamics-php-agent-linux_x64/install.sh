...
agentVersionId="22.1.0.434GA.22.1.0.434.128e8510f75bad650f4b38945aeee4d71d6d499d"
ztsFlag=""
...
if [ -n "${phpVersionId}" ] ; then
    case "${phpVersionId}" in
        ...
        *)
            ...
            fatal_error "PHP Version must be one of 5.6, 7.0, 7.1, 7.2, 7.3, 7.4 or 8.0"
            ;;
    esac
fi
...
if [ $phpVersionNum -lt 50600 -o $phpVersionNum -gt 80099 ]; then
    fatal_error "Only PHP versions 5.6, 7.0-7.4, and 8.0 are currently supported"
